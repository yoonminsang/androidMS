...
public class ExerciseRoutine_5x5_3_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_exercise_routine_5x5_3_);

        Button bt_5x5_3_go = (Button) findViewById(R.id.bt_5x5_3_go);
        bt_5x5_3_go.setOnClickListener(new View.OnClickListener() {
            @Override
