...
public class ExerciseRoutine_5x5_2_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_exercise_routine_5x5_2_);

        Button bt_5x5_2_go = (Button) findViewById(R.id.bt_5x5_2_go);
        bt_5x5_2_go.setOnClickListener(new View.OnClickListener() {
            @Override
